...
<form action="{{route('cliente.guardar')}}" method="post">
    ...
    <div class="form-group">
        <input type="text" id="p_apellidos" name="p_apellidos" autofocus autocomplete="name"
                  class="form-control" placeholder="Primer apellido" value="{{old('p_apellidos')}}">
    </div>
    <div class="form-group">
        <input type="text" id="s_apellidos" name="s_apellidos" autofocus autocomplete="name"
        class="form-control" placeholder="Segundo apellido" value="{{old('s_apellidos')}}">
    </div>
    <div class="form-row">
        <div class="form-group col-md-6">
